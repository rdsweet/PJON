/* This sketch is a modified copy of the example:
   ...
   SoftwareBitBang bus which is connected to the Surrogate via Ethernet TCP.
   ...
   the id if this device is on the SWBB bus.
   ...
   allowing that process to transparently be a part of a SWBB bus. The Surrogate
